...
export const metadata: Metadata = {
    title: 'Tendor',
    description:
        'Dellete Account - Tendor is a web developer service that provides an admin dashboard for managing web development projects and services.',
    keywords: [
        'Tendor',
    ...
    twitter: {
        ...
        title: 'Delete Account - Tendor',
        description:
            'Delete Account - Tendor - Web developer community for managing web development projects and services.',
