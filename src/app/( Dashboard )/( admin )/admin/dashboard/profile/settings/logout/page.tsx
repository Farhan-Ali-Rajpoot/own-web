...
export const metadata: Metadata = {
    title: 'Tendor',
    description:
        'Logout - Tendor is a web developer service that provides an admin dashboard for managing web development projects and services.',
    keywords: [
        'Tendor',
    ...
    openGraph: {
        title: 'Logout  – TENDOR',
        description:
            'Logout - Tendor - Web developer community for managing web development projects and services.',
        url: `${wn}/blog`,
