import { VerifyCodeSubmitHandler } from "@/components/pages/auth/login/resetPassword/VerifyCodeSubmitHandler"; 
  ...
  return (
    <>
      ...
      <div className="rounded-2xl p-8 sm:p-[2vw] 3xl:p-10 w-full max-w-md sm:max-w-[30vw] 3xl:max-w-lg">
        ...
        <form data-form="verify-code" className="space-y-6 sm:space-y-[1.5vw]">
          {/* Code Input - Fixed for 6-digit codes */}
          <FormInput
            name="code"
            type="text"
            placeholder="123456"
          ...
          {/* Submit Button */}
          <FormSubmitButton>Verify Code</FormSubmitButton>
