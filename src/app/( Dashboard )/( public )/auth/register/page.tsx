...
import RegisterForm from '@/components/pages/auth/register/Register';
...
export const metadata: Metadata = {
    title: 'Register Account - Tendor - A Web Developer community that provides good desgined website.',
    description:
