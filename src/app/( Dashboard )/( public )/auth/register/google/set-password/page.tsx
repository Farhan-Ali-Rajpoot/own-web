...
import SetPassword from '@/components/pages/auth/register/SetPasswor'
...
export const metadata: Metadata = {
    title: 'Set Password - Tendor - A Web Developer community that provides good desgined website.',
    description:
