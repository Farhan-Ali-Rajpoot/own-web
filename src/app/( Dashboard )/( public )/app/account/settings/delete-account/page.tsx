...
// import DeleteAccountPage from '@/components/pages/auth/delete-account/DeleteAccount'
...
export const metadata: Metadata = {
    title: 'Delete Account - Tendor - A Web Developer community that provides good desgined website.',
    description:
